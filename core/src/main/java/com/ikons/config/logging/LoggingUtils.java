package com.ikons.config.logging;
...
public class LoggingUtils {
   ...
   * @param context a {@link ch.qos.logback.classic.LoggerContext} object.
   * @param customFields a {@link java.lang.String} object.
   * @param logstashProperties a {@link IkonsConfiguration.Logging.Logstash} object.
   */
  public static void addLogstashTcpSocketAppender(LoggerContext context, String customFields,
                                                  IkonsConfiguration.Logging.Logstash logstashProperties) {
   ...
   * @param context a {@link ch.qos.logback.classic.LoggerContext} object.
   * @param customFields a {@link java.lang.String} object.
   * @param properties a {@link IkonsConfiguration.Logging} object.
   */
  public static void addContextListener(LoggerContext context, String customFields, IkonsConfiguration.Logging properties) {
  ...
  private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
    private final IkonsConfiguration.Logging loggingProperties;
    private final String customFields;

    private LogbackLoggerContextListener(IkonsConfiguration.Logging loggingProperties, String customFields) {
