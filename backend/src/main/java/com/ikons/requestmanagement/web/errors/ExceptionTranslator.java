...
import com.ikons.requestmanagement.web.vm.FieldErrorVM;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
  ...
  public ResponseEntity<Problem> handleEmailAlreadyUsedException(EmailAlreadyUsedException ex, NativeWebRequest request) {
    EmailAlreadyUsedAlertException problem = new EmailAlreadyUsedAlertException();
  ...
  public ProblemBuilder prepare(final Throwable throwable, final StatusType status, final URI type) {
    ...
    if (activeProfiles.contains(IkonsConstants.SPRING_PROFILE_PRODUCTION)) {
  ...
  private boolean containsPackageName(String message) {
    ...
    return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.ikons");
  }
}
