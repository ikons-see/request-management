...
@Configuration
@Profile({IkonsConstants.SPRING_PROFILE_PRODUCTION})
public class StaticResourcesWebConfiguration implements WebMvcConfigurer {
  ...
  public StaticResourcesWebConfiguration(IkonsConfiguration ikonsConfiguration) {
  ...
  private int getJHipsterHttpCacheProperty() {
    return ikonsConfiguration.getHttp().getCache().getTimeToLiveInDays();
  }
